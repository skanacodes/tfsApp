...
class CampingScreen extends StatefulWidget {
  final String id;
  const CampingScreen({Key? key, required this.id}) : super(key: key);
...
class _CampingScreenState extends State<CampingScreen>
  ...
  final List<Tab> tabs = <Tab>[
    ...
    const Tab(text: "Add Camping Detail(s)"),
  ];
  List<String> visitorsType = [
    'East African',
    'Non East African',
  ];
  List<String> tentType = [
    'Private Owned',
    'Government Owned',
  ];
  List<String> tentCapacity = [
    '1',
    '2',
    '3',
    '4',
  ...
  Future getData() async {
    ...
    try {
      var tokens = await SharedPreferences.getInstance()
          .then((prefs) => prefs.getString('token'));
      var headers = {"Authorization": "Bearer ${tokens!}"};
      var url = Uri.parse('$baseUrlTest/api/v1/safari_camping/${widget.id}');
              ...
              Padding(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  style: const TextStyle(
                      color: Colors.white, fontFamily: 'Ubuntu'),
                  iconEnabledColor: Colors.black,
                  items: tentType.map<DropdownMenuItem<String>>((String value) {
                    return DropdownMenuItem(
                      value: value,
                      child: Container(
                        width: double.infinity,
  ...
  Future UpdateTasks(id) async {
    try {
      ...
      var tokens = await SharedPreferences.getInstance()
          .then((prefs) => prefs.getString('token'));
      var headers = {"Authorization": "Bearer ${tokens!}"};
      var url = Uri.parse('$baseUrlTest/api/v1/safari_camping/update');
      // //print(url);
      // //print(visitorTypes);
      final response = await http.post(
        ...
        body: {
          "id": id.toString(),
          "safari_id": widget.id,
          "tent_type": tentTypeval,
          "visitor_type": visitorTypes,
          "tent_capacity": tentcapVal,
      ...
      body: TabBarView(
        ...
        children: tabs.map((Tab tab) {
          return SingleChildScrollView(
              child: tab.text == "Camping" ? listMember() : membersForm());
        }).toList(),
      ),
    );
  }
                                  ...
                                  child: Row(children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            Text(
                                                "Tent Type: ${Data[index]["tent_type"]}",
                                                style: const TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 15,
                                                    fontWeight:
                                            ...
                                            Text(
                                                "Tent Capacity: ${Data[index]["tent_capacity"]}",
                                                style: TextStyle(
  ...
  Future deleteData(id) async {
    try {
      var tokens = await SharedPreferences.getInstance()
          .then((prefs) => prefs.getString('token'));
      var headers = {"Authorization": "Bearer ${tokens!}"};
      var url = Uri.parse('$baseUrlTest/api/v1/safari_camping/destroy/$id');
  ...
  Future createTourMember() async {
    try {
      var tokens = await SharedPreferences.getInstance()
          .then((prefs) => prefs.getString('token'));
      var headers = {"Authorization": "Bearer ${tokens!}"};
      var url = Uri.parse('$baseUrlTest/api/v1/safari_camping');
      ////print(tentcapVal);
              ...
              SafeArea(
                child: Padding(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    iconEnabledColor: Colors.black,
                    items:
                        tentType.map<DropdownMenuItem<String>>((String value) {
                      return DropdownMenuItem(
                        value: value,
                        child: Container(
                          width: double.infinity,
