...
import 'package:tfsappv1/screens/ApprovalPermit/export_previewer.dart';
import 'package:tfsappv1/screens/ApprovalPermit/pdfPreviewer.dart';
import 'package:tfsappv1/services/constants.dart';
import 'package:tfsappv1/services/size_config.dart';

class ExportLetters extends StatefulWidget {
  static String routeName = "/exportLetters";
  const ExportLetters({super.key});

  @override
  State<ExportLetters> createState() => _ExportLettersState();
}

class _ExportLettersState extends State<ExportLetters> {
  ...
  Future getData() async {
    ...
    try {
      ...
      var url = Uri.parse('$baseUrl/api/v1/exp-letter');
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () {
                                  String? url =
                                      "$baseUrl/uploads/export_letters/${Data[index]["ref_no"]}.pdf";
                                  print(url);
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => ExportPreviewer(
                                                path: url.toString(),
                                                letterType: true,
                                                id: Data[index]["id"]
                                                    .toString(),
                                                name:
                                                    "Export Letter No. ${Data[index]["ref_no"]}",
                                              )));
                                },
                                child: Container(
                                            ...
                                            child: Row(children: [
                                              ...
                                              Flexible(
                                                ...
                                                child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                          "Client Name: ${Data[index]["export"]["exporter_name"]}",
                                                      ...
                                                      Text(
                                                          "Issuer: ${Data[index]["export"]["place_of_issue"]}",
                                                          style: TextStyle(
                                                              color: Colors
                                                                  .grey[500])),
                                                    ]),
