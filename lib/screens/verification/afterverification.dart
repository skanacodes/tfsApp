...
// copy the file to a new path
  ...
  Future<int> submitSubscription(
    ...
    var request = http.MultipartRequest(
      'POST',
      Uri.parse("https://mis.tfs.go.tz/fremis-test/api/v1/verify-tp"),
    );
    ...
    request.files.addAll({
      await http.MultipartFile.fromPath("consignment_image[]", img1),
      await http.MultipartFile.fromPath("consignment_image[]", img1)
    });
  ...
  Widget build(BuildContext context) {
    ...
    var len = widget.previousCheckpoint == null
        ? 0
        ...
        children: <Widget>[
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                        flex: 4,
                        child: Text(widget.tpData['tp_number'].toString()))
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                        flex: 4,
                        child: Text(widget.tpData['destination'].toString()))
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    ...
                    Expanded(
                        flex: 4,
                        child: Text(widget.tpData['vehicle_no'].toString()))
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    ...
                    Expanded(flex: 3, child: Text('Trailer Number : ')),
                    Expanded(
                        flex: 4,
                        child: Text(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(flex: 3, child: Text('Forest Name : ')),
                    Expanded(
                        flex: 4,
                        child: Text(widget.tpData['forest_name'].toString()))
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    ...
                    Expanded(flex: 3, child: Text('Other Forest : ')),
                    Expanded(
                        flex: 4,
                        child: Text(
                            widget.tpData['other_forest'].toString() == 'null'
                                ? ''
                                : widget.tpData['other_forest'].toString()))
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    ...
                    Expanded(flex: 3, child: Text('Vehicle Capacity : ')),
                    Expanded(
                        flex: 4,
                        child: Text(
                            widget.tpData['vehicle_capacity'].toString() ==
                                    'null'
                                ? ''
                                : widget.tpData['vehicle_capacity'].toString() +
                                    " Tons"))
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(flex: 3, child: Text('Transport Mode : ')),
                    Expanded(
                        flex: 4,
                        child: Text(
                            widget.tpData['transport_mode'].toString() == 'null'
                                ? ''
                                : widget.tpData['transport_mode'].toString()))
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    Expanded(
                        ...
                        child: Text(
                            widget.tpData['receipt_date'].toString() == 'null'
                                ? ''
                                : widget.tpData['receipt_date'].toString()))
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    Expanded(
                        ...
                        child: Text(
                            widget.tpData['issued_by'].toString() == 'null'
                                ? ''
                                : widget.tpData['issued_by'].toString()))
                  ],
                ),
                ButtonBar(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(flex: 3, child: Text('Check-Point Name: ')),
                          Expanded(
                              flex: 4,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(flex: 3, child: Text('Verification-Code: ')),
                          Expanded(
                              flex: 4,
                              child: Text(widget.previousCheckpoint[i]
                                              ['verification_code']
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(flex: 3, child: Text('Verification-Time: ')),
                          Expanded(
                              flex: 4,
                              child: Text(widget.previousCheckpoint[i]
                                              ['verified_at']
                                      ...
                                      'null'
                                  ? ''
                                  : widget.previousCheckpoint[i]['verified_at']
                                      .toString()))
                        ],
                      ),
                      Divider(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                              flex: 4,
                              child: Text(widget.tpProduct[i]['product_name']
                                          .toString() ==
                                      'null'
                                  ? ''
                                  : widget.tpProduct[i]['product_name']
                                      .toString())),
                        ],
                      ),
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                              flex: 4,
                              child: Text(widget.tpProduct[i]['quantity']
                                          .toString() ==
                                      'null'
                                  ? ''
                                  : widget.tpProduct[i]['quantity'].toString() +
                                      " " +
                                      widget.tpProduct[i]['unit'].toString()))
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          Expanded(flex: 3, child: Text('Volume : ')),
                          Expanded(
                              flex: 4,
                              child: Text(widget.tpProduct[i]['volume']
                                          .toString() ==
                                      'null'
                                  ? ''
                                  : widget.tpProduct[i]['volume'].toString()))
                        ],
                      ),
                      Divider(
                        color: Colors.purple,
            ...
            child: Container(
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  fillColor: Color(0xfff3f3f4),
                  filled: true,
                  labelText: "Verification Code: $verCode",
                  //hintText: verCode,
                  border: InputBorder.none,
                  isDense: true,
                  contentPadding: EdgeInsets.fromLTRB(30, 10, 15, 10),
          ...
          Container(
            ...
            child: Card(
              elevation: 10,
              child: Center(
                child: Text("Click On The Icons To Take Atleast Two Pictures"),
              ),
            ),
          ),
          Container(
