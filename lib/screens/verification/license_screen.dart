// ignore_for_file: avoid_print, prefer_typing_uninitialized_variables, use_build_context_synchronously, prefer_interpolation_to_compose_strings
...
class LicenseEditiScreen extends StatefulWidget {
  static String routeName = "/LicenseEditing";
  const LicenseEditiScreen({Key? key}) : super(key: key);

  @override
  State<LicenseEditiScreen> createState() => _LicenseEditiScreenState();
}

class _LicenseEditiScreenState extends State<LicenseEditiScreen> {
  ...
  Future getData() async {
    ...
    try {
      ...
      var url = Uri.parse('$baseUrlTest/api/v1/lc_edit');
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => LicenseEditShow(
                                          data: [Data[index]],
                                          operation: "approval",
                                        ))),
                            child: Container(
                                        ...
                                        child: Row(children: [
                                          ...
                                          Flexible(
                                            ...
                                            child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                      "License Number: ${Data[index]["license_no"]}",
                                                      style: const TextStyle(
                                                          color: Colors.black,
                                                          fontSize: 15,
                                                          fontWeight:
