...
class ExyensionApprovalWidget extends StatefulWidget {
  static String routeName = "/approvalwidget";
  final List? data;
  final String? operation;
  const ExyensionApprovalWidget({Key? key, this.data, this.operation})
      : super(key: key);

  @override
  State<ExyensionApprovalWidget> createState() =>
      _ExyensionApprovalWidgetState();
}

class _ExyensionApprovalWidgetState extends State<ExyensionApprovalWidget> {
